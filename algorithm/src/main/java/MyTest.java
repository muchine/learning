...
public class MyTest {
    ...
    public static void main(String[] args) {
        ...
        BigDecimal divider = new BigDecimal(10000).multiply(new BigDecimal(Math.pow(2, 100)));
        System.out.println(sum.divide(divider));
...
//        advanced.week2.Diet.Matrix m = new advanced.week2.Diet.Matrix(a, b, c);

        for (int i = 0; i < 1; i++) {
//            advanced.week2.Diet.Position p = m.findPivotPosition();
//            System.out.println("position pivot: " + p);
//            m.pivot(p);
        }
    }
