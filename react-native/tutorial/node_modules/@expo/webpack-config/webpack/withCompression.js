...
function addCompressionPlugins(webpackConfig, config) {
    ...
    const gzipConfig = config_1.overrideWithPropertyOrConfig(build.gzip, exports.DEFAULT_GZIP_OPTIONS, true);
    const brotliConfig = config_1.enableWithPropertyOrConfig(build.brotli, exports.DEFAULT_BROTLI_OPTIONS, true);
