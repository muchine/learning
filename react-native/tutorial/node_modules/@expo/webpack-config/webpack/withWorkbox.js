...
function withWorkbox(config, options = {}) {
    ...
    config.entry = () => __awaiter(this, void 0, void 0, function* () {
        ...
        const swPath = path_1.join(projectRoot, 'register-service-worker.js');
        if (entries.app && !entries.app.includes(swPath) && autoRegister) {
            const content = (yield fs_extra_1.readFile(require.resolve('../web-default/register-service-worker.js'), 'utf8'))
