...
public class WhitespaceInterpreterTest {
    ...
    @Test
    public void test1() {
        String s = new WhitespaceInterpreter("ssstntnstnnn", null).execute();
        System.out.println(s);
    }

    @Test
    public void test2() {
        String code = "ssstnssstsnsssttnstnttsssssntnstnnnssstnssstsnsssttnstnttsssssntnstnnn";
        System.out.println(new WhitespaceInterpreter(code, null).execute());
    }

    @Test
    public void test3() {
        String code = "nsssnssstntnstnnnntnnnn";
        System.out.println(new WhitespaceInterpreter(code, null).execute());
    }

    @Test
    public void test4() {
        String code = "ssstsnnstsnsssttnnstsnssstnnstsnnnnnsssntnstnnn";
        System.out.println(new WhitespaceInterpreter(code, null).execute());
    }
