...
public class RankingPokerHandTest {
    private RankingPokerHand.Result loss = RankingPokerHand.Result.LOSS;
    private RankingPokerHand.Result win = RankingPokerHand.Result.WIN;
    private RankingPokerHand.Result tie = RankingPokerHand.Result.TIE;
    ...
    private void Test(String description, RankingPokerHand.Result expected, String playerHand, String opponentHand) {
        System.out.println("------");
        RankingPokerHand player = new RankingPokerHand(playerHand);
        RankingPokerHand opponent = new RankingPokerHand(opponentHand);
